          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="footer-col" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="space-y-2">
                ...
                <a href="resources.php" class="flex items-center gap-2 w-full px-4 py-2 rounded-lg bg-white/50 border border-sky-200 hover:bg-white/70 transition-all duration-300 text-slate-700 text-sm font-medium hover:shadow-lg hover:shadow-sky-200">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="about_us.php" class="flex items-center gap-2 w-full px-4 py-2 rounded-lg bg-white/50 border border-sky-200 hover:bg-white/70 transition-all duration-300 text-slate-700 text-sm font-medium hover:shadow-lg hover:shadow-sky-200">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
